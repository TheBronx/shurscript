(function ($, createModule, undefined) {
	...
	mod.getPreferenceOptions = function () {
		...
		return [
			...
			createPref({type: 'tags', mapsTo: 'hiddenKeywords', caption: 'Ignorar hilos por palabras clave <b>(separadas por comas)</b>', buttons: true, plain: true}),
			...
			createPref({type: 'tags', mapsTo: 'highlightKeywords', caption: 'Resaltar hilos por palabras clave <b>(separadas por comas)</b>', buttons: true, plain: true}),
