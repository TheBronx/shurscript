(function ($, createModule, undefined) {
	...
	mod.getPreferenceOptions = function () {
		...
		unsafeWindow.FilterThreads_selectBox = function (preference) {
			bootbox.dialog({
		...
		return [
			...
			createPref({type: 'tags', mapsTo: 'hiddenUsers', caption: 'Ignorar hilos por usuario <b>(separados por comas)</b>', subCaption: '<div class="shur-sub-button"><a href="#" onclick="FilterThreads_importIgnoreList(); return false;" class="btn btn-xs btn-default">Importar de la lista de ignorados</a> <a href="#" onclick="FilterThreads_selectBox(\'hiddenUsers\'); return false;" class="btn btn-xs btn-default">Ver en plano</a></div>'}),
			...
			createPref({type: 'tags', mapsTo: 'highlightUsers', caption: 'Resaltar hilos por usuario <b>(separados por comas)</b>', subCaption: '<div class="shur-sub-button"><a href="#" onclick="FilterThreads_importBuddyList(); return false;" class="btn btn-xs btn-default">Importar de la lista de contactos</a> <a href="#" onclick="FilterThreads_selectBox(\'highlightUsers\'); return false;" class="btn btn-xs btn-default">Ver en plano</a></div>'}),
