...
//
//		// Carga plantilla
//		var template = settingsWindow.helper.GM.getResourceText('modalhtml'),
//			dust = settingsWindow.helper.dust;
//
//		// Compila y guarda en dust
//		dust.compile(template, 'settingsWindow');
//
//		dust.render('settingsWindow', {shurScriptVersion: SHURSCRIPT.scriptVersion}, function(err, out) {
//			console.log(out);
//		});
//
//		// Mete eventos
